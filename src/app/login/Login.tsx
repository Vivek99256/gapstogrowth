          ...
          <div className="max-w-sm mx-auto w-full">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                ...
                className={`w-full py-3.5 px-4 bg-[#3B5BF5] text-white font-semibold rounded-xl transition-all duration-200 flex items-center justify-center
                  ${isSubmitting 
                    ? 'opacity-80 cursor-not-allowed' 
                    : 'hover:bg-[#2563EB] active:bg-[#1F2A6D] shadow-md shadow-[#3B5BF5]/30 hover:shadow-lg hover:shadow-[#3B5BF5]/40'}`}
              >
                {isSubmitting ? (
                  <>
